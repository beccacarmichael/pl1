...
### You must enable GitHub pages to view HTML documents at the url `https://beccacarmichael.github.io/pl1`. 
...
Now your repository will be accessible under GitHub Pages (an HTML Web Server) at `https://beccacarmichael.github.io/pl1` where `[username]` is your GitHub account username and the repository name is `pl1`. Note you must type this manually into the URL above, or better yet, modify the ReadMe.md to change [username] to be your actual username! 
