...
The simplemap can be opened in GitHub Pages by modifying the url `https://fleminggeom.github.io/googlemaps-beccacarmichael/services/simplemap.html`. Remember to replace the `[username]` portion with your actual GitHub username. 
